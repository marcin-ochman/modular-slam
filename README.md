...
Modular SLAM is written in C++20 and Python3. It's designed to work as separate library but it also supports ROS.

**This is development branch of modular-slam v1.**
