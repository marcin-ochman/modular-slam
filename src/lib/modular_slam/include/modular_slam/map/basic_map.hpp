...
class BasicMap : public IMap<slam3d::SensorState, slam3d::LandmarkState, rgbd::RgbdOrbKeypointDescriptor>
{
  public:
    BasicMap();
    void update(const FrontendOutput<slam3d::SensorState, slam3d::LandmarkState, rgbd::RgbdOrbKeypointDescriptor>&
                    frontendOutput) override;

    void update(const BackendOutputType& frontendOutput) override;
    void visit(IMapVisitor<slam3d::SensorState, slam3d::LandmarkState, rgbd::RgbdOrbKeypointDescriptor>& visitor,
    ...
    void addObservation(const LandmarkKeyframeObservation<slam3d::SensorState, slam3d::LandmarkState,
                                                          rgbd::RgbdOrbKeypointDescriptor>&);
  ...
  private:
    ...
    void visitLandmarksOfNeighbours(
        IMapVisitor<slam3d::SensorState, slam3d::LandmarkState, rgbd::RgbdOrbKeypointDescriptor>& visitor,
        const GraphBasedParams& graph, std::shared_ptr<slam3d::Keyframe> refKeyframe);
